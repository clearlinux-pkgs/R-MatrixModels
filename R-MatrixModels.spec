...
export LANG=C
export SOURCE_DATE_EPOCH=1496597806
...
mkdir -p ~/.R
mkdir -p ~/.stash
echo "CFLAGS = $CFLAGS -O3 -march=haswell -flto -ftree-vectorize " > ~/.R/Makevars
...
echo "CFLAGS = $CFLAGS -O3 -march=skylake-avx512 -flto -ftree-vectorize " > ~/.R/Makevars
